...
if __name__=="__main__":
    ...
    # react-flow nodes/edges state as/is
    edges = [
        {
            "id": "xy-edge_90e8e114-64ef-47b4-9895-9db8eb14d857-b_0625afa9-4998-43b5-9689-460786cefdff-a",
            "source": "90e8e114-64ef-47b4-9895-9db8eb14d857",
            "sourceHandle": "b",
            "target": "0625afa9-4998-43b5-9689-460786cefdff",
            "targetHandle": "a",
            "data": {
        ...
        },
        {
            ...
            "source": "0625afa9-4998-43b5-9689-460786cefdff",
            "sourceHandle": "b",
            "target": "5a3d6df5-60c3-40d7-9e78-28a8731958b2",
            "targetHandle": "a",
            "data": {
        ...
        },
        {
            ...
            "source": "5a3d6df5-60c3-40d7-9e78-28a8731958b2",
            "sourceHandle": "b",
            "target": "63a7913c-f3da-431f-8701-e18984762e59",
            "targetHandle": "a",
            "data": {
        ...
        },
        {
            ...
            "source": "5a3d6df5-60c3-40d7-9e78-28a8731958b2",
            "sourceHandle": "b",
            "target": "918e7f75-2db2-47eb-bc8c-835936d92f0a",
            "targetHandle": "a",
            "data": {
        ...
        },
        {
            ...
            "source": "90e8e114-64ef-47b4-9895-9db8eb14d857",
            "sourceHandle": "b",
            "target": "229f395b-3201-457c-a963-7e9a04dcab64",
            "targetHandle": "a",
            "data": {
        ...
        },
        {
            ...
            "source": "229f395b-3201-457c-a963-7e9a04dcab64",
            "sourceHandle": "b",
            "target": "10982656-8943-4ab4-bfe5-f7482c1adb55",
            "targetHandle": "a",
            "data": {
        ...
        },
        {
            ...
            "source": "10982656-8943-4ab4-bfe5-f7482c1adb55",
            "sourceHandle": "b",
            "target": "65aa745b-41b5-442c-a99a-b9192f44350e",
            "targetHandle": "a",
            "data": {
        ...
        # Extract their paragraphs


        # Peform smilairty search to reterive list of videos
        # that teach how to execute the actual sequence
    ...
    # define required node/edge data
